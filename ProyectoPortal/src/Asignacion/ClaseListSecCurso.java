...
public class ClaseListSecCurso {
    ...
    public List<ListaSecCurso> cargarDatosListSeccionCurso(int iDusuario){
        ...
        Iterator<ListaSecCurso> iteradorSeccCur2 = miLisSecCur.iterator();
        while(iteradorSeccCur2.hasNext()){
            ListaSecCurso miLista = iteradorSeccCur2.next();
            if(!equals(miLista.getUsuarioCatId()==2))
                
                
            iteradorSeccCur2.remove();
           
        }
        
        System.out.println("Cursosciclo");
        Iterator<ListaSecCurso> iteradorListaSecCur2 = miLisSecCur.iterator();
        while (iteradorListaSecCur2.hasNext()) { 
            ListaSecCurso ListaSecCur = iteradorListaSecCur2.next();
